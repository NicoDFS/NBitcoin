...
namespace NBitcoin.Altcoins.HashX12.Crypto.SHA3
{
    ...
    {
        public Skein256Base(NBitcoin.Altcoins.Nist5.HashSize a_hash_size)
            : base(a_hash_size, 32)
        {
        }
    ...
    internal abstract class Skein512Base : SkeinBase
    {
        ...
        public Skein512Base(NBitcoin.Altcoins.Nist5.HashSize a_hash_size)
            : base(a_hash_size, 64)
        {
        }
    ...
    internal abstract class SkeinBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SkeinBase(NBitcoin.Altcoins.Nist5.HashSize a_hash_size, int a_block_size)
