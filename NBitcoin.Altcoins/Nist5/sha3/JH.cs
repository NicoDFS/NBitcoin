...
namespace NBitcoin.Altcoins.Nist5.Crypto.SHA3
{
    internal class JH224 : JHBase
    {
        public JH224() :
            base(NBitcoin.Altcoins.Nist5.HashSize.HashSize224)
        {
        }
    }
    ...
    {
        public JH256() :
            base(NBitcoin.Altcoins.Nist5.HashSize.HashSize256)
        {
        }
    }
    ...
    {
        public JH384() :
            base(NBitcoin.Altcoins.Nist5.HashSize.HashSize384)
        {
        }
    }
    ...
    {
        public JH512() :
            base(NBitcoin.Altcoins.Nist5.HashSize.HashSize512)
        {
        }
    }
